...
class ProjectCreation1View(CreateView):
    form_class =ProjectCreationForm1
    model = Property_rent
    template_name = 'project/rent_home.html/'
    context_object_name = 'create_project1'
    success_url = '/property/list_project2/'
    
    def get_queryset(self):
        return super().get_queryset() 


class ProjectList2View(ListView):
    model = Property_rent
    template_name = 'project/project_list_rent.html/'
    context_object_name = 'project_list2'
    
    def get_queryset(self):
        return super().get_queryset() 

class ProjectList3View(ListView):
    model = Property_rent
    template_name = 'project/rentproperty.html/'
    context_object_name = 'project_list3'
...
class ProjectUpdateView1(UpdateView):
    model = Property_rent
    form_class = ProjectCreationForm1
    template_name = 'project/rent_home.html/'
    success_url = '/property/list_project2/'
...
class ProjectDetailView1(DetailView):
    model = Property_rent
    template_name = 'project/projectdetail1.html'
    context_object_name = 'project_details1' 
...
class ProjectDeleteView1(DeleteView):
    model = Property_rent
    def get(self, request, *args, **kwargs):
        return self.delete(request, *args, **kwargs)
