...
def sendMail(request):
    subject = "welcome to property finder"
    message = "hello new user , thanks for choosing us "
    email_from = settings.EMAIL_HOST_USER
    recipient_list = ['imrankhanbaloch811@gmail.com']
...
def search1(request):
    ...
    # alllist = Property_info.objects.all()
    alllist = Property_info.objects.filter(name__contains= query1)
